...
class EditProfileTextPage extends StatefulWidget {
  const EditProfileTextPage({
    super.key,
    required this.title,
    required this.label,
  ...
  @override
  State<EditProfileTextPage> createState() => _EditProfileTextPageState();
}

class _EditProfileTextPageState extends State<EditProfileTextPage> {
                ...
                Container(
                  ...
                  child: const Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Nút Lưu chỉ bật khi nội dung có thay đổi và không để trống.',
                          style: TextStyle(
                            color: AppColor.textSecondary,
