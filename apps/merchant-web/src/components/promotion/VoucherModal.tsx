...
type Props = {
    ...
    /**
     * Payload theo schema Voucher:
     * promotion_id, code, total_usage_limit, per_user_limit, start_date, end_date, is_active
     */
...
export default function VoucherModal({
    ...
    return (
        <Modal
            title={editing ? "Chỉnh sửa voucher" : "Tạo voucher"}
            open={open}
            onCancel={onCancel}
            onOk={handleOk}
                ...
                >
                    <Select
                        ...
                        options={voucherPromotions.map((p: any) => ({
                            value: String(p._id),
                            label: `${p.name} • ${p.scope} • ${p.apply_level}`,
                        }))}
