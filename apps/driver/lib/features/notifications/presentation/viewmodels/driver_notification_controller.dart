...
import 'driver_notification_state.dart';

class DriverNotificationController
    extends StateNotifier<DriverNotificationState> {
  DriverNotificationController(this._repo)
    : super(const DriverNotificationState());

  final DriverNotificationRepository _repo;
  ...
  void prependRealtime(DriverNotificationItem item) {
